  ...
  const currentDate = timestamp
    ...
    const renderTemperatureIcon = () => {
      if (temperatureCelsius > 23) {
        ...
        return <AcUnitIcon style={{ marginLeft: '10px', fontSize: '3rem', color: 'white' }} />;
      } else {
    ...
    return (
      <div style={{ backgroundColor: '#4682B4', color: 'white', borderRadius: '0.5rem',width:'265px',padding:'30px' }}>
